...
impl DistillationProcess {
    ...
    pub fn distill_epoch(
        ...
        self.distinctions_preserved.fetch_add(preserved, Ordering::Relaxed);
        self.distinctions_archived.fetch_add(archived, Ordering::Relaxed);
...
mod tests {
    ...
    fn test_classify_distinctions() {
        ...
        let classification = distillation.classify_distinctions(
            &distinctions,
            &ref_graph,
            &causal_graph,
        );
